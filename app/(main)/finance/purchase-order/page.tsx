        ...
        {isOpen && selectedOrder && (
            <ActionDialog
                ...
                actions={[
                    ...
                    { label: pdfLoading ? 'Downloading...' : 'Download PDF', subLabel: 'Download as PDF', icon: pdfLoading ? <Loader2 size={16} className="animate-spin" /> : undefined, onClick: downloadPDF },
                    { label: csvLoading ? 'Downloading...' : 'Download CSV', subLabel: 'Download as CSV', icon: csvLoading ? <Loader2 size={16} className="animate-spin" /> : undefined, onClick: downloadCSV },
                ]}
