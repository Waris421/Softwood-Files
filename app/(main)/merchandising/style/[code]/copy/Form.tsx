...
export default function StyleDuplicateForm({
    code,
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const apiRedirectUrl = `${redirectUrl}/${formData.Target}/edit`;
        ...
        <div className="max-w-6xl mx-auto p-6 bg-base-100 rounded-xl shadow-xl border border-base-200">
            <div className="flex items-center justify-between mb-8 border-b pb-4">
                <div className="flex items-center gap-3">
                    ...
                    <h2 className="text-2xl font-bold">Copying Style Card</h2>
                </div>
            </div>
