...
import {BarChart3, CalendarDays, Factory, ShieldCheck, ShoppingCart, Wallet, BriefcaseBusiness, Layers} from "lucide-react";
...
const modules = [
  ...
  { id: 8, src: Merchandising, href: 'merchandising', title: 'Merchandising', icon: Layers, color: "text-indigo-500", size: "col-span-1"},
